// src/app/contact/page.tsx - Styled Version
'use client';
      ...
      <section className="py-20 bg-charcoal" dir="rtl">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-center bg-charcoal-light/30 border border-lightgrey/10 rounded-xl p-12"
          >
            ...
            <div className="flex justify-center gap-6 mb-8">
              {academyInfo.social.instagram && (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                >
                  <div className="w-16 h-16 bg-charcoal border border-gold/20 rounded-full flex items-center justify-center group-hover:bg-gold/10 group-hover:border-gold/40 transition-all">
            ...
            <p className="text-lightgrey">
              הצטרפו לקהילה שלנו וקבלו עדכונים, טיפים ותכנים בלעדיים
            </p>
          </motion.div>
        </div>
      </section>
