...
export const instructors = [
  {
    ...
    bio: 'בר שם טוב הוא המייסד והבעלים של אקדמיית The Fader – ספר, מנטור, ואיש חזון עם ניסיון של מעל 10 שנה בתחום. את הדרך שלו התחיל מספר קטן עם חלום גדול, והיום הוא מוביל מאות תלמידים שבחרו ללמוד את מקצוע הספרות מהלב – ולעשות מזה קריירה אמיתית. בר ידוע בגישה הישירה, בתשומת הלב לכל תלמיד, וביכולת לחבר בין טכניקה מדויקת, מיתוג אישי וניהול עסק מצליח. במהלך השנים פיתח תוכנית הכשרה ייחודית שמקנה כלים פרקטיים, תרגול מהיום הראשון, וליווי אמיתי גם אחרי הקורס. החזון: להפוך כל תלמיד שרוצה – לברבר עם מטרה.',
...
export const academyInfo = {
  ...
  story: {
    title: 'הסיפור שלנו',
    content: `האקדמיה שלנו נולדה מתוך חזון פשוט אבל עוצמתי – להרים את הסטנדרט של מקצוע הספרות בישראל, ולהפוך אותו לאיכות בינלאומית.
