...
export const instructors = [
  ...
  },
  {
    ...
    name: 'דוד לוי',
    title: 'מדריך בכיר',
    bio: 'דוד הוא ספר מומחה עם 12 שנות ניסיון בתעשייה. מתמחה בטכניקות חיתוך מתקדמות ועיצוב זקן. זוכה תחרויות ספרות ארציות ובינלאומיות. דוד מלמד בקורס המתחילים ומעביר סדנאות מיוחדות בנושא טכניקות Fade ועיצוב זקן. הוא ידוע בגישתו הסבלנית והיכולת שלו להעביר ידע מורכב בצורה פשוטה ונגישה.',
