...
export const IconUsageExample: React.FC = () => {
  return (
    <div className="p-8 space-y-4">
      <h3 className="text-2xl font-bold mb-4">Icon System Usage Examples</h3>
      
      {/* Basic usage */}
      <div className="flex items-center gap-4">
        <PhoneIcon className="text-gold" />
        <WhatsAppIcon className="text-green-500" size={32} />
        <EmailIcon className="text-lightgrey" strokeWidth={1.5} />
      </div>
      
      {/* With hover effects */}
      <div className="flex items-center gap-4">
        <button className="p-2 hover:bg-gold/10 rounded-full transition-colors">
          <InstagramIcon className="text-gold hover:text-gold/80" />
        </button>
        <button className="p-2 hover:bg-gold/10 rounded-full transition-colors">
          <FacebookIcon className="text-gold hover:text-gold/80" />
        </button>
      </div>
      
      {/* Different sizes */}
      <div className="flex items-center gap-4">
        <LocationIcon size={16} className="text-gold" />
        <LocationIcon size={24} className="text-gold" />
        <LocationIcon size={32} className="text-gold" />
        <LocationIcon size={48} className="text-gold" />
      </div>
      
      {/* Filled vs outlined */}
      <div className="flex items-center gap-4">
        <StarIcon className="text-gold" />
        <StarIcon className="text-gold" filled />
        <HeartIcon className="text-red-500" />
        <HeartIcon className="text-red-500" filled />
      </div>
    </div>
  );
};