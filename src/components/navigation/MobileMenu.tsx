        ...
        >
          ...
          <div className="flex flex-col items-center justify-between h-full py-20 px-8 relative z-10">
            ...
            >
              ...
              <div className="flex items-center space-x-reverse space-x-4 border border-lightgrey border-opacity-20 bg-charcoal/20 rounded-full py-1 px-4">
                <SocialLinks social={academyInfo.social} onClick={(e) => e.stopPropagation()} />
              </div>
